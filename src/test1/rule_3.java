...
public class rule_3 extends JFrame {
	 ...
	 */
	public rule_3() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_3.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_3.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 3 :");
		...
		txtrEnterOne.setText("3) And if the word gets fully completed, you win the game!");
		...
		lblBG.setIcon(new ImageIcon(rule_3.class.getResource("/images/background_rules.jpg")));
