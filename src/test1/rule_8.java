...
public class rule_8 extends JFrame {
	 ...
	 */
	public rule_8() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_8.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_8.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 8 :");
		...
		txtrEnterOne.setText("8) If you want to add some words which are complicated\r\n and spice up things, click on the \"Add a Word\" button.");
		...
		lblBG.setIcon(new ImageIcon(rule_8.class.getResource("/images/background_rules.jpg")));
