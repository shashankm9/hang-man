...
public class rule_4 extends JFrame {
	 ...
	 */
	public rule_4() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_4.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_4.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 4 :");
		...
		txtrEnterOne.setText("4) And as you enter the incorrect guesses, the hang pole \r\nwill progressively get constructed to build a whole body \r\nof a man.");
		...
		lblBG.setIcon(new ImageIcon(rule_4.class.getResource("/images/background_rules.jpg")));
