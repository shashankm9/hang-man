...
public class rule_6 extends JFrame {
	 ...
	 */
	public rule_6() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_6.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_6.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 6 :");
		...
		txtrEnterOne.setText("6) If the word isn't completed even after the last chance, \r\nthe man gets hanged and you lose :(");
		...
		lblBG.setIcon(new ImageIcon(rule_6.class.getResource("/images/background_rules.jpg")));
