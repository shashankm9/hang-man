...
public class rule_2 extends JFrame {
	 ...
	 */
	public rule_2() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_2.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_2.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 2 :");
		...
		txtrEnterOne.setText("2) If the guess you have made is correct, the vacant \r\ndashes will be replaced  by your letter wherever it \r\noccurs in the actual word.");
		...
		lblBG.setIcon(new ImageIcon(rule_2.class.getResource("/images/background_rules.jpg")));
