...
public class rule_5 extends JFrame {
	 ...
	 */
	public rule_5() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(rule_5.class.getResource("/images/logo.jpg")));
		setTitle("HANG MAN");
		...
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setIcon(new ImageIcon(rule_5.class.getResource("/images/back1.png")));
		...
		JLabel lblNewLabel_1 = new JLabel("RULE NO 5 :");
		...
		txtrEnterOne.setText("5) The stage where the whole body of a man can be \r\nobserved, is considered as the last guess.");
		...
		lblBG.setIcon(new ImageIcon(rule_5.class.getResource("/images/background_rules.jpg")));
